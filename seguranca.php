...
$_SG['caseSensitive'] = false;     // Usar case-sensitive? Onde 'franze' é diferente de 'FRANZE'
$_SG['validaSempre'] = true;       // Deseja validar o usuário e a senha a cada carregamento de página?
// Evita que, ao mudar os dados do usuário no banco de dado o mesmo continue logado.
$_SG['servidor'] = 'localhost';    // Servidor MySQL
$_SG['usuario'] = 'root';          // Usuário MySQL
$_SG['senha'] = '';                // Senha MySQL
$_SG['banco'] = 'planos';      // Banco de dados MySQL
$_SG['paginaLogin'] = 'login.php'; // Página de login
$_SG['tabela'] = 'cad_usuarios';       // Nome da tabela onde os usuários são salvos
// ==============================
...
if ($_SG['conectaServidor'] == true) {
  ...
  mysql_select_db($_SG['banco'], $_SG['link']) or die("MySQL: Nao foi possivel conectar-se ao banco de dados [".$_SG['banco']."].");
}
